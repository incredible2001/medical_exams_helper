...
| **F9** | 整理生成速通手册 | 增量分批处理新错题 → 归入 7 大分组下的**细学科**（如临床内科→内科学/传染病学…） → 生成 `data/速通手册/<学科>.md` + 合并版 `考前速通手册.html`（左侧学科级固定目录/折叠/打印薄弱知识点） |

> 真题与**模拟卷（万人模考等）**错题均可识别记录；手册薄弱知识点含关键信息高亮，打印可只输出薄弱点。常见报错见文末「常见问题」。
